...
public class Main {
    ...
    private void newFilmWasMade() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            film.setLength((short) 500);
            film.setReplacementCost(BigDecimal.TEN);
            film.setRentalRate(BigDecimal.ZERO);
            film.setLanguage(language);
            film.setDescription("New scary film");
            film.setTitle("Very scary movie");
            ...
            filmText.setTitle("Very scary movie");
    ...
    private void customerRentInventory(Customer customer) {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            payment.setAmount(BigDecimal.valueOf(77.77));
    ...
    private Customer createCustomer() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            address.setAddress("str Independet, 100 ");
            address.setPhone("555-55-55");
            address.setCity(city);
            address.setDistrict("Oops");
